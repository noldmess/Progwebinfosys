<div class="span9">
	<div class="hero-unit">
		...
		<p><?php if(isset($TEMPLATE['image']) && $TEMPLATE['image'] !== 'NOIMG'){ echo '<img src="'.ltrim(dirname($_SERVER['SCRIPT_NAME']), ' \\').'/art_images/'.$TEMPLATE['id'].'.png" style="float:'.$TEMPLATE['align'].'">';}echo $TEMPLATE['parsedText'];?></p>
